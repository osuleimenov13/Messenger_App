...
class RegisterViewController: UIViewController {
    ...
    @objc private func didTapRegisterButton() {
        ...
        DatabaseManager.shared.doesUserExists(with: email) { [weak self] exists in
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Profile Picture", message: "How would you would you like to select a picture?", preferredStyle: .actionSheet)
